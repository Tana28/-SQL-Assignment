...
============================================================
1️⃣LIMIT → Specifies how many records to return.
2️⃣OFFSET → Specifies how many records to skip before starting to return rows.
*/
-- Example table
...
------------------------------------------------------------
1️⃣Improves readability and organization of complex queries.
2️⃣Allows reusing intermediate query results.
3️⃣Helps avoid subquery repetition.
4️⃣Enables recursive queries (like hierarchical data traversal).
============================================================
...
-- ✅ Explanation:
-- 1️⃣The CTE `regional_avg` computes the average sale per region.
-- 2️⃣The main query compares each employee’s sales with their regional average.
-- 3️⃣Only employees whose sales exceed the average are displayed.
-- ==========================================================
-- ✅ Summary:
------------------------------------------------------------
...
------------------------------------------------------------
1️⃣Eliminate redundant data (avoid data duplication)
2️⃣Ensure logical data storage (data dependency makes sense)
3️⃣Improve data consistency and efficiency
============================================================
*/

/*
============================================================
1️⃣FIRST NORMAL FORM (1NF)
------------------------------------------------------------
✅ Rule:
